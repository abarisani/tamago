...
TEXT ·Init(SB),NOSPLIT|NOFRAME,$0
	...
	MOVV	github·com∕usbarmory∕tamago∕goos·RamStart(SB), R3
	MOVV	github·com∕usbarmory∕tamago∕goos·RamSize(SB), R5
	MOVV	github·com∕usbarmory∕tamago∕goos·RamStackOffset(SB), R6
	ADDVU	R5, R3, R3
	SUBVU	R6, R3, R3
