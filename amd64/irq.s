...
TEXT ·handleNMI(SB),NOSPLIT|NOFRAME,$0
	// NMIs are generated by CPU.Task to wake up the next AP (see ·apstart)
...
TEXT ·handleRelay(SB),NOSPLIT|NOFRAME,$0
	// IRQs are relayed by CPU.ClearInterrupt to unmask IRQs on the BSP
