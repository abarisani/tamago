...
add_ext_entries:
	...
	// set stack pointer
	MOVQ	github·com∕usbarmory∕tamago∕mem·RamStart(SB), SP
	MOVQ	github·com∕usbarmory∕tamago∕mem·RamSize(SB), AX
	MOVQ	github·com∕usbarmory∕tamago∕mem·RamStackOffset(SB), BX
	ADDQ	AX, SP
	SUBQ	BX, SP
