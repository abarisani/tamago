...
TEXT ·cpuinit_el1(SB),NOSPLIT|NOFRAME,$0
	...
	// set stack pointer
	MOVD	github·com∕usbarmory∕tamago∕mem·RamStart(SB), R1
	MOVD	R1, RSP
	MOVD	github·com∕usbarmory∕tamago∕mem·RamSize(SB), R1
	MOVD	github·com∕usbarmory∕tamago∕mem·RamStackOffset(SB), R2
	ADD	R1, RSP
	SUB	R2, RSP
